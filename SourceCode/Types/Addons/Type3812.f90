Subroutine Type3812
   ...
   !    DESCRIPTION
   !------------------------------------------------------------------------------------
   ! Subroutine Type3812 implements a .LT. (less than) logic operation in a TRNSYS simulation.
   ! It compares two input signals and returns 1 if the first input is less than the
   ...
   !DEC$ATTRIBUTES DLLEXPORT :: TYPE3812
   !------------------------------------------------------------------------------------
   !    VARIABLES
   !------------------------------------------------------------------------------------
   Use TrnsysConstants
   ...
   output_flag = (input_y - input_x) > tolerance
