Subroutine Type3808
   ...
   !    DESCRIPTION
   !------------------------------------------------------------------------------------
   ! Subroutine Type3808 implements an .EQ. (equals) logic operation in a TRNSYS simulation.
   ! It compares two input signals and returns 1 if they are equal, or 0 if they are different.
   !
   ! Inputs:
   ...
   !DEC$ATTRIBUTES DLLEXPORT :: TYPE3808
   !------------------------------------------------------------------------------------
   !    VARIABLES
   !------------------------------------------------------------------------------------
   Use TrnsysConstants
   ...
   output_flag = input_x .EQ. input_y
